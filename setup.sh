...
~/.pixi/bin/pixi global install zsh tmux==3.6a nvim fzf wget git unzip ninja ripgrep fd-find ffmpeg imagemagick tree-sitter-cli nodejs python zoxide yazi bat hexyl jq
